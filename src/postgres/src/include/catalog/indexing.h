...
//DECLARE_UNIQUE_INDEX(pg_class_tblgrp_index, 9004, on pg_class using btree(reltablegroup oid_ops));
//#define ClassTblgrpIndexId  9004
...
DECLARE_UNIQUE_INDEX(pg_tablegroup_oid_index, 9001, on pg_tablegroup using btree(oid oid_ops));
#define TablegroupOidIndexId  9001
